...
public class AppConstants {
    ...
    public static final String DOC_DESCRIPTION = "API documentation for Translation Management System App";
    public static final String DOC_OWNER = "Chander Parkash";
    public static final String DOC_EMAIL = "chanderparkash179@gmail.com";
    public static final String DOC_LICENSE_TITLE = "Apache 2.0";
    public static final String DOC_LICENSE_URL = "http://www.apache.org/licenses/LICENSE-2.0";
}